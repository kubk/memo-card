...
const ptBr: Translation = {
  ...
  no_personal_decks_start: "Você ainda não tem nenhum baralho pessoal. Sinta-se à vontade para",
  no_personal_decks_create: "criar um",
  no_personal_decks_explore: "ou explorar os baralhos públicos abaixo. Bom aprendizado! 😊",
  ...
  deck_search_not_found_description: "Tente atualizar os filtros para ver mais baralhos",
  ...
  card_speak_description: "Reproduzir áudio falado para cada cartão para melhorar a pronúncia",
  ...
  delete_deck_confirm: "Tem certeza de que deseja remover o baralho da sua coleção? Esta ação não pode ser desfeita",
  delete: "Deletar",
  ...
  warning_telegram_outdated_description: "Por favor, atualize seu Telegram para garantir o funcionamento estável deste aplicativo.",
  settings_review_notifications: "Notificações de revisão",
  settings_time: "Hora",
  settings_review_notifications_hint: "Lembretes diários ajudam você a lembrar de repetir os cartões",
  ...
  deck_form_no_cards_alert: "Por favor, adicione pelo menos 1 cartão para criar um baralho",
