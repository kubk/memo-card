...
const ru: Translation = {
  ...
  card_input_mode_get: "Вы получите карточку",
  ...
  payment_choose_duration: "Выберите длительность",
  ai_cards_left: "Осталось ИИ карточек",
...
const es: Translation = {
  ...
  card_input_mode_get: "Obtendrás una tarjeta",
  ...
  ai_cards_left: "Tarjetas de IA restantes",
  wysiwyg_red: "Rojo",
...
const ptBr: Translation = {
  ...
  card_input_mode_manual: "Entrada manual",
  card_input_mode_get: "Você receberá um cartão",
  generate: "Gerar",
  ...
  payment_and: " e ",
  ai_cards_left: "Cartões de IA restantes",
