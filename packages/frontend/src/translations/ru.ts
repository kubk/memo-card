...
export const ru: Translation = {
  ...
  deck_description: "Набор карточек для изучения",
  folder: "Папка",
  create_folder_option: "Папку",
  folder_description: "Группа колод для организации",
  ...
  teacher_stats_students: "Ученики",
  teacher_stats_decks_shared: "Колоды в обучении",
  teacher_stats_no_decks:
    "Сначала создайте и поделитесь колодой. Ученики, которые добавят ваши колоды, появятся здесь.",
  teacher_stats_top_students: "Лучшие ученики",
  teacher_stats_no_student_activity:
    "Активности учеников пока нет. Поделитесь ссылкой на колоду с классом.",
  teacher_stats_top_decks: "Лучшие колоды",
  teacher_stats_no_deck_activity: "В колодах у учеников пока нет активности.",
  teacher_stats_all_students: "Все ученики",
  teacher_stats_students_load_error: "Не удалось загрузить учеников.",
  teacher_stats_no_students: "Учеников пока нет.",
  teacher_stats_all_decks: "Все колоды",
  teacher_stats_decks_load_error: "Не удалось загрузить колоды.",
  teacher_stats_no_shared_decks: "Ученики еще не добавили ваши колоды.",
  teacher_stats_load_error: "Не удалось загрузить статистику учителя.",
  teacher_stats_see_all: "Все",
  teacher_stats_last_repeat: "Последнее повторение",
  teacher_stats_decks: "Колоды",
  teacher_stats_seen: "Изучено",
  ...
  teacher_plan_student_statistics_title: "Статистика учеников",
  teacher_plan_student_statistics_description:
    "Прогресс учеников и статистика колод у учеников",
  teacher_plan_anki_import_title: "Импорт Anki",
  teacher_plan_anki_import_description: "Неограниченный импорт и экспорт Anki",
