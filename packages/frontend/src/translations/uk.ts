...
export const uk: Translation = {
  ...
  teacher_stats_students: "Учні",
  teacher_stats_decks_shared: "Колоди в навчанні",
  teacher_stats_no_decks:
    "Спочатку створіть і поділіться колодою. Учні, які додадуть ваші колоди, з'являться тут.",
  teacher_stats_top_students: "Найкращі учні",
  teacher_stats_no_student_activity:
    "Активності учнів ще немає. Поділіться посиланням на колоду з класом.",
  ...
  teacher_stats_seen: "Переглянуто",
  ...
  teacher_plan_student_statistics_title: "Статистика учнів",
  teacher_plan_student_statistics_description:
    "Прогрес учнів і статистика колод в учнів",
  teacher_plan_anki_import_title: "Імпорт Anki",
  teacher_plan_anki_import_description: "Необмежений імпорт і експорт Anki",
