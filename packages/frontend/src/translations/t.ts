...
const ar: Translation = {
  ...
  share_perpetual_link: "مشاركة رابط دائم",
  share_one_time_link: "مشاركة رابط لمرة واحدة",
  share_deck_settings: "مشاركة المجموعة",
  share_folder_settings: "مشاركة المجلد",
  share_one_time_access_link: "رابط وصول لمرة واحدة",
  share_one_time_access_link_description:
    "الرابط متاح لمستخدم واحد فقط. بعد الاستخدام الأول، سيكون الرابط غير صالح",
  share_access_duration: "مدة الوصول",
  share_days: "أيام",
  share_days_description: "مدة توفر المجموعة بعد الاستخدام الأول",
  share_one_time_links_usage: "روابط لمرة واحدة",
  share_used: "تم استخدام الرابط من قبل",
  share_unused: "لم يتم استخدامه",
  ...
  share_access_duration_days: "مدة الوصول بالأيام",
  share_access_duration_no_limit: "بدون حد",
  share_deck_access_created_at: "تم الإنشاء في",
  share_no_links: "لم تقم بإنشاء أي روابط لمرة واحدة لهذه المجموعة",
  ...
  share_no_links_for_folder: "لم تقم بإنشاء أي روابط لمرة واحدة لهذا المجلد",
  go_back: "العودة",
...
const fa: Translation = {
  ...
  share_perpetual_link: "اشتراک‌گذاری لینک دائمی",
  share_one_time_link: "اشتراک‌گذاری لینک یک‌بار مصرف",
  share_deck_settings: "اشتراک‌گذاری دسته کارت",
  share_folder_settings: "اشتراک‌گذاری پوشه",
  share_one_time_access_link: "لینک دسترسی یک‌بار مصرف",
  share_one_time_access_link_description:
    "این لینک فقط برای یک کاربر در دسترس است. پس از اولین استفاده، لینک نامعتبر خواهد شد",
  share_access_duration: "مدت دسترسی",
  share_days: "روزها",
  share_days_description:
    "دسته کارت پس از اولین استفاده چه مدت در دسترس خواهد بود",
  share_one_time_links_usage: "لینک‌های یک‌بار مصرف",
  share_used: "لینک توسط استفاده شده است",
  share_unused: "استفاده نشده",
  share_link_copied: "لینک در کلیپ‌بورد کپی شد",
  share_copy_link: "کپی لینک",
  share_access_duration_days: "مدت دسترسی به روز",
  share_access_duration_no_limit: "بدون محدودیت",
  share_deck_access_created_at: "ایجاد شده در",
  share_no_links:
    "شما هنوز هیچ لینک یک‌بار مصرف برای این دسته کارت ایجاد نکرده‌اید",
  ...
  share_no_links_for_folder:
    "شما هنوز هیچ لینک یک‌بار مصرف برای این پوشه ایجاد نکرده‌اید",
  go_back: "بازگشت",
...
const uk: Translation = {
  ...
  share_no_links_for_folder:
    "Ви ще не створили одноразових посилань для цієї папки",
  share_folder_settings: "Поділитися папкою",
  ...
  share_perpetual_link: "Поділитися постійним посиланням",
  share_one_time_link: "Поділитися одноразовим посиланням",
  share_deck_settings: "Поділитися колодою",
  share_one_time_access_link: "Одноразове посилання доступу",
  share_one_time_access_link_description:
    "Посилання доступне тільки для одного користувача. Після першого використання посилання стане недійсним",
  share_access_duration: "Тривалість доступу",
  share_days: "Днів",
  share_days_description:
    "Як довго колода буде доступна після першого використання",
  share_one_time_links_usage: "Одноразові посилання",
  share_used: "Посилання використано",
  share_unused: "Не використано",
  share_link_copied: "Посилання скопійовано в буфер обміну",
  share_copy_link: "Копіювати посилання",
  share_access_duration_days: "Тривалість доступу в днях",
  share_access_duration_no_limit: "Без обмежень",
  share_deck_access_created_at: "Створено",
  share_no_links: "Ви ще не створили одноразових посилань для цієї колоди",
