...
export const fa: Translation = {
  ...
  create: "ایجاد",
  deck: "دسته کارت",
  create_deck_option: "دسته کارت",
  deck_description: "مجموعه‌ای از کارت‌ها",
  folder: "پوشه",
  create_folder_option: "پوشه",
  ...
  user_stats_7d: "۷ روز",
  user_stats_30d: "۳۰ روز",
  user_stats_memory: "کارت‌ها",
  user_stats_to_review: "برای مرور",
  user_stats_remembered_cards: "به‌خاطر سپرده‌شده",
  user_stats_all_cards: "همه",
  user_stats_streaks: "روزهای پیاپی",
  user_stats_current_streak: "روزهای پیاپی فعلی",
  user_stats_best_streak: "بهترین روزهای پیاپی",
  teacher_stats_students: "دانش‌آموزان",
  teacher_stats_decks_shared: "دسته‌های در حال مطالعه",
  teacher_stats_no_decks:
    "ابتدا یک دسته بسازید و آن را به اشتراک بگذارید. دانش‌آموزانی که دسته‌های شما را اضافه کنند اینجا نمایش داده می‌شوند.",
  teacher_stats_top_students: "دانش‌آموزان برتر",
  teacher_stats_no_student_activity:
    "هنوز فعالیتی از دانش‌آموزان نیست. لینک دسته را با کلاس خود به اشتراک بگذارید.",
  teacher_stats_top_decks: "دسته‌های برتر",
  ...
  teacher_plan_student_statistics_title: "آمار دانش‌آموزان",
  teacher_plan_student_statistics_description:
    "پیشرفت دانش‌آموزان و آمار دسته‌هایی که اضافه کرده‌اند",
  teacher_plan_anki_import_title: "وارد کردن Anki",
  teacher_plan_anki_import_description: "وارد کردن و صادر کردن نامحدود Anki",
  ...
  freeze_rule_1: "همه کارت‌های شما متوقف می‌شوند و هیچ اعلانی دریافت نخواهید کرد.",
  freeze_rule_2:
